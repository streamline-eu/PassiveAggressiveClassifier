...
import hu.sztaki.ilab.ps.passive.aggressive.PassiveAggressiveParameterServer.OptionLabeledVector
import hu.sztaki.ilab.ps.passive.aggressive.algorithm._
...
object PassiveAggressiveMultiClassTraining {
  ...
  private val log = LoggerFactory.getLogger(classOf[PassiveAggressiveMultiClassTraining])
